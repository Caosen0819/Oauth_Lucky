package cn.sen.lucky.domain.util;
 ...
 */
@Component
public class RedisUti2 {

    @Resource
    private RedisTemplate<String, Object> redisTemplate;

    public RedisUti2(RedisTemplate<String, Object> redisTemplate) {
    ...
    public List<Object> getActivityList(String key) {
        List<Object> languageList = redisTemplate.opsForList().range("AllActivity", 0, -1);
        return languageList;
    }
    public Long rightpush(String key, List<?> value){
     ...
     * @return
     */
    public boolean lSet3(String key, List<?> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0) {
                expire(key, time);
