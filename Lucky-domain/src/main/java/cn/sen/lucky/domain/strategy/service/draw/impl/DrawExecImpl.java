...
import cn.sen.lucky.domain.strategy.service.draw.AbstractDrawBase;
...
//        boolean isSuccess = strategyRepository.deductStock(strategyId, awardId);
        // 2023年9月21 优化成redis里面的hashmap
        int newstock = strategyRepository.deductStockByRedis(strategyId, awardId);
        // 返回结果，库存扣减成功返回奖品ID，否则返回NULL 「在实际的业务场景中，如果中奖奖品库存为空，则会发送兜底奖品，比如各类券」
        return newstock >=0 ? awardId : null;
    }
}
