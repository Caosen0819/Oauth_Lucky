...
public class Constants {
    ...
    public static final class RedisKey {
        ...
        // 抽奖活动库存 Key
        private static final String Lucky_ACTIVITY_STOCK_COUNT = "Lucky_activity_stock_count_";

        public static String KEY_Lucky_ACTIVITY_STOCK_COUNT(Long activityId) {
            return Lucky_ACTIVITY_STOCK_COUNT + activityId;
        }

        // 抽奖活动库存锁 Key
        private static final String Lucky_ACTIVITY_STOCK_COUNT_TOKEN = "Lucky_activity_stock_count_token_";

        public static String KEY_Lucky_ACTIVITY_STOCK_COUNT_TOKEN(Long activityId, Integer stockUsedCount) {
            return Lucky_ACTIVITY_STOCK_COUNT_TOKEN + activityId + "_" + stockUsedCount;
        }
